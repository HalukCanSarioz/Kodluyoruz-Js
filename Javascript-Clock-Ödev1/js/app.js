...
name.innerHTML = prompt("Name?","Haluk Can");
...
const time = new Date();
let background = 
(time.getHours() >= 5 && time.getHours() < 12) ? document.body.style.backgroundImage = "url('../img/morning.jpg')" :
(time.getHours() >= 12 && time.getHours() < 17) ? document.body.style.backgroundImage = "url('../img/afternoon.jpg')" :
(time.getHours() >= 17 && time.getHours() < 21) ? document.body.style.backgroundImage = "url('../img/evening.jpg')" :
(time.getHours() >= 21 || time.getHours() < 5) ? document.body.style.backgroundImage = "url('../img/night.jpg')" :
"";
//BODY EVENTS - END
